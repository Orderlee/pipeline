...
class DatasetBuilderSettings(BaseModel):
    output_dir: str
...
class Settings(BaseSettings):
    ...
    # Optional legacy sections (kept for compatibility)
    qdrant: Optional[QdrantSettings] = None
    cvat: Optional[CvatSettings] = None
    dataset_builder: Optional[DatasetBuilderSettings] = None
