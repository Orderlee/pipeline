...
Usage:
    # vlm-processed 클립 (기존)
    python ls_tasks.py create --prefix sourcei_v2/01_27_collection_data

    # vlm-raw 원본 영상 (auto-detect)
    python ls_tasks.py --bucket vlm-raw create --prefix source-h/falldown --auto-detect

    # vlm-processed 이미지 (auto-detect)
    python ls_tasks.py create --prefix sourcej/falldown/image --auto-detect
...
def main() -> int:
    ...
    p_create.add_argument("--prefix", required=True, help="MinIO prefix (예: sourcei_v2/01_27_collection_data)")
