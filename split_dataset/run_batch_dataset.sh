...
#
# What it does:
# - Iterate categories under BATCH_ROOT_PREFIX (e.g. cohort-a/processed_data/<category>/...)
...
#
# Override example:
#   BATCH_ROOT_PREFIX=cohort-a/processed_data \
...
BATCH_ROOT_PREFIX="${BATCH_ROOT_PREFIX:-cohort-a/processed_data}"
