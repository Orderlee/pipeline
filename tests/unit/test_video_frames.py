...
def test_zero_duration_returns_single_zero() -> None:
    ...
    assert plan_frame_timestamps(duration_sec=0, fps=None, frame_count=None, frame_interval_sec=1.0) == [0.0]
    assert plan_frame_timestamps(duration_sec=0.0, fps=None, frame_count=None, frame_interval_sec=1.0) == [0.0]
