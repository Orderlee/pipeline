...
2026-05-29 운영 진단으로 ``sourcej_v2`` LS 프로젝트 32 tasks 가 모두
...
def test_violence_synonyms_include_fight():
    """sourcej_v2 회귀 — Gemini ``fight`` event 가 violence 로 매핑되어야 함."""
...
def test_climbing_up_synonyms_include_unsafe_climbing_activity():
    """sourcej_v2 회귀 — ``unsafe_climbing_activity`` 가 climbing up 으로 매핑."""
