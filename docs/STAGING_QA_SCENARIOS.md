...
| incoming 테스트 데이터 | `/home/user/mou/staging/incoming/` | 테스트 폴더 존재 |
...
# 예시 폴더 구조:
# /home/user/mou/staging/incoming/test_smoke_001/
#   ├── smoke_video_01.mp4
#   ├── smoke_video_02.mp4
#   └── smoke_video_03.mp4
# /home/user/mou/staging/incoming/test_fire_002/
#   ├── fire_video_01.mp4
#   └── fire_video_02.mp4
# /home/user/mou/staging/incoming/test_mixed_003/
#   ├── weapon_video_01.mp4
...
| 6 | archive 이동 | `/home/user/mou/staging/archive/test_smoke_001/` 존재 | 파일 이동 완료 |
...
### 시나리오 16-1: http://10.0.0.10:3031 접속
...
```python
import boto3
s3 = boto3.client('s3', endpoint_url='http://10.0.0.36:9002',
