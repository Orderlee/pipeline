...
### 시나리오
1. 이미 ingest된 27개 비디오 (tmp_data_2: 25, source-d: 2) 활용
...
|---|-----------|-----------|-----------|------|
| 1 | spec 없이 ingest_router | 27건 → pending_spec | tmp_data_2: 25, source-d: 2 → pending_spec | **PASS** |
...
| 4 | source-d (spec 미등록) | pending_spec 유지 | 2건 pending_spec 유지 | **PASS** |
...
### 시나리오
1. source-d에 대해 `SPEC-QA-003-001` (timestamp+bbox, pending_resolved) 등록
...
| 4 | raw_files 전이 | source-d 2건 → ready_for_labeling | 2건 ready_for_labeling, spec_id=SPEC-QA-003-001 | **PASS** |
