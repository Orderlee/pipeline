...
| 오늘 GT | finalized 부모 288행 / **이미지 248장** / 박스 1,558개, 전부 vanguardhealthcarevhc, 카테고리 patient/person | GT 낟알 3종을 원장에 구분 기록; 뱅크 클래스와 무손실 대응 안 됨 |
...
2. vanguard 288장의 GT 축 편입은 crosswalk 에 patient/person 사상을 **결정한 뒤에만**.
