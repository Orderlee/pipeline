...
- **커버리지 최악 영상**(= 담당 문장이 없는 영상)은 `margin_min` 오름차순 맨 위:
  ...
  |---|---|---|
  | `area-a_화재_20260320_144814` (fire 153프레임) | −0.104 / **0%** | −0.055 / 79% |
  | `ODCarea-a_연기_20260323_1508` | — | −0.050 / **29%** |
...
|---|---|---|
| held = ODCarea-a | +0.61pp | **−0.09pp** |
| held = area-a | +1.32pp | **−0.18pp** |
| held = area-b | **+10.37pp** | **−0.17pp** |
