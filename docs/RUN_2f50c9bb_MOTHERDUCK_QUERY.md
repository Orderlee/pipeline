...
- MotherDuck 동기화 대상은 운영 8개 테이블뿐입니다:
  ...
  - `image_labels`
- 근거 파일:
  - [local_duckdb_to_motherduck_sync.py](/home/user/work_p/Datapipeline-Data-data_pipeline/src/python/local_duckdb_to_motherduck_sync.py#L41)
  - [service.py](/home/user/work_p/Datapipeline-Data-data_pipeline/src/vlm_pipeline/defs/dispatch/service.py#L206)
  - [ops.py](/home/user/work_p/Datapipeline-Data-data_pipeline/src/vlm_pipeline/defs/ingest/ops.py#L109)
