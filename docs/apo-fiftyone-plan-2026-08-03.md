...
| project | n | 이벤트 | 구성 |
|---|---|---|---|
| cohort-b | 73,390 | 1,488 | fall 318 / smoke 669 / fire 501 |
| cohort-a | 33,766 | 1,245 | **fall 1,239 / smoke 5 / fire 1** ← 사실상 fall 전용 |
| appdata | 24,572 | 2,726 | fall 1,367 / fire 327 / smoke 1,032 |
| loc-c_raw | 10,899 | 199 | 거의 fall |
...
- project 22개 중 이벤트가 거의 없는 곳(loc-c 계열)은 전이 검정에서 제외하거나 별도 tier
...
4. **APO 실데이터 미확인** — APO 내장 데이터셋(약 700장) + source-i/source-k 는 아직 안 봤다.
