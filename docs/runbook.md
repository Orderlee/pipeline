...
- **조치:** production은 `MINIO_ENDPOINT=http://10.0.0.36:9000`, test는 `MINIO_ENDPOINT=http://10.0.0.36:9002`로 유지
...
```bash
# 1. test runtime 중지
# 2. test MinIO 객체 전부 삭제 (endpoint: 10.0.0.36:9002)
