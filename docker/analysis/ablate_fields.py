...
env: AB_PROFILE(hyundai) AB_TOPN(400) AB_WORDS(1) AB_RETRY(3)
"""
...
PROFILES = {
    "hyundai": ("/data/fiftyone/hyundai", "Hyundai"),
...
def main() -> None:
    ...
    ap.add_argument("--profile", default=os.environ.get("AB_PROFILE", "hyundai"),
