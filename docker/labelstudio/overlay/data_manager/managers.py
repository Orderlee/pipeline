...
def annotate_avg_active_seconds(queryset):
    # GCP 외주 포크: 태스크의 어노테이션 평균 순수 활성 작업시간(초). avg_lead_time 과 동형.
    return queryset.annotate(avg_active_seconds=Avg('annotations__active_seconds'))
...
settings.DATA_MANAGER_ANNOTATIONS_MAP = {
    ...
    'avg_active_seconds': annotate_avg_active_seconds,
