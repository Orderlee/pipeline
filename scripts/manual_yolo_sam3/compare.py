...
사용 예시:
  PYTHONPATH=src python3 scripts/manual_yolo_sam3/compare.py
  PYTHONPATH=src python3 scripts/manual_yolo_sam3/compare.py --max-videos 1
  PYTHONPATH=src python3 scripts/manual_yolo_sam3/compare.py --resume --skip-yolo
"""
...
if __name__ == "__main__" and __package__ in (None, ""):
    ...
    __package__ = "manual_yolo_sam3"

# repo root = grandparent of scripts/manual_yolo_sam3/
...
from manual_yolo_sam3.reporting import generate_report_assets, generate_time_resource_report
from manual_yolo_sam3.resources import ModelResourceSampler
...
DEFAULT_INPUT_DIR = Path("/home/user/mou/incoming/tmp_data_2")
