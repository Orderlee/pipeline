...
SAMPLE_ROOT = Path(os.environ.get("BENCH_SAMPLE_ROOT", "/home/user/mou/staging/archive"))
MANIFEST_CSV = Path(
    os.environ.get(
        "BENCH_MANIFEST",
        "/home/user/work_p/Datapipeline-Data-data_pipeline/scripts/migrate_legacy/pilot_manifest.csv",
    )
)
