...
DEST_ROOT 를 staging incoming (/home/user/mou/staging/incoming) 으로 지정해 수행.
...
NAS_ROOT = Path(os.environ.get("NAS_ROOT", "/home/user/mou/nas_secondary/datasets/projects"))
