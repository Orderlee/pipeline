"""sourcej(VHC) — SAM3 bbox backfill 일회성 스크립트.
...
# raw_files.source_unit_name은 "sourcej(VHC)"지만 raw_key는 sanitize되어
# lowercase로 저장된다 ("sourcej/..."). SAM3 asset의 find_pending_images가
