#!/usr/bin/env python3
"""One-shot: delete MinIO objects for source-c/source-b 20260402 from vlm-raw bucket."""
from minio import Minio
from minio.deleteobjects import DeleteObject

client = Minio("10.0.0.36:9000", access_key="minioadmin", secret_key="minioadmin", secure=False)

prefixes = [
    "source-c-event-bucket/20260402/",
    "source-b-event-bucket/20260402/",
]
