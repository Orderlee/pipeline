...
사용:
  PYTHONPATH=src python3 scripts/test_video_extract_yolo_bench.py
  PYTHONPATH=src python3 scripts/test_video_extract_yolo_bench.py --video-dir /home/user/mou/staging/tmp_data_2 --max-videos 5
  PYTHONPATH=src python3 scripts/test_video_extract_yolo_bench.py --no-yolo
  PYTHONPATH=src python3 scripts/test_video_extract_yolo_bench.py --preset-names interval_0.5s_q90 interval_1s_q85 --workers 1 2 4
"""
...
DEFAULT_VIDEO_DIR = Path("/home/user/mou/staging/tmp_data_2")
...
def main() -> None:
    ...
    out_root = args.out_dir or Path(tempfile.mkdtemp(prefix="test_extract_"))
