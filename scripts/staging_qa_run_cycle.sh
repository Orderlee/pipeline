...
# 사용: STAGING_ROOT=/home/user/mou/staging bash scripts/staging_qa_run_cycle.sh tmp_data_2 qa_c1_ts timestamp
#       STAGING_ROOT=... bash scripts/staging_qa_run_cycle.sh source-d qa_x bbox captioning
set -euo pipefail
REPO="$(cd "$(dirname "$0")/.." && pwd)"
cd "$REPO"
STAGING_ROOT="${STAGING_ROOT:-/home/user/mou/staging}"
export STAGING_ROOT
